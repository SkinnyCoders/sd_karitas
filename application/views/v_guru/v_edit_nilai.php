        ...
        <div class="col-md-12">
          ...
          <div class="card card-default ">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button type="submit" id="simpan" class="btn btn-primary float-right">Perbarui Penilain Siswa</button>
                    </form>
                </div>
            </div>
     ...
     $('#simpan').click(function(e){
      ...
      e.preventDefault();
        ...
        function(isConfirm) {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url() ?>guru/nilai/edit/<?=$this->uri->segment(4)?>",
                data: $('#formNilai').serialize(),
                success: function(respone) {
                window.location.href = "<?= base_url('guru/nilai/') ?>";
                },
                error: function(request, error) {
                window.location.href = "<?= base_url('guru/nilai/edit/') ?><?=$this->uri->segment(4)?>";
                },
            });
            } else {
